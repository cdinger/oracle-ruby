if [ "$TARGETPLATFORM" == "linux/amd64" ]; then
  ...
  curl -sL -o instantclient-sqlplus https://download.oracle.com/otn_software/linux/instantclient/2380000/instantclient-sqlplus-linux.x64-23.8.0.25.04.zip
  ...
  curl -sL -o instantclient-sqlplus https://download.oracle.com/otn_software/linux/instantclient/2380000/instantclient-sqlplus-linux.arm64-23.8.0.25.04.zip
fi

unzip instantclient-basic.zip -d /opt
unzip instantclient-sdk.zip -d /opt
unzip instantclient-sqlplus.zip -d /opt
